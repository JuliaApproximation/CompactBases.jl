...
@testset "Derivatives" begin
    @testset "Derivative operators" begin
        ...
        @testset "k = 7" begin
            ...
            @test CompactBases.diffop!(similar(B.S), B, 3) ≈
            ...
            @test CompactBases.diffop!(similar(B.S), B, 4) ≈
            ...
            @test CompactBases.diffop!(similar(B.S), B, 5) ≈
            ...
            @test CompactBases.diffop!(similar(B.S), B, 6) ≈
